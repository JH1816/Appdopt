...
urlpatterns = [
    ...
    path('index/edit/<str:username>', app.views.edit, name='edit'),
    path('index/postView/<int:post_id>', app.views.postView, name = 'postView'),
    path('index/postEdit/<int:post_id>', app.views.postEdit, name = 'postEdit'),
